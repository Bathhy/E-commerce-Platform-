...
public class Query {
    ...
    public static String GET_PRODUCT = "SELECT `e-com-platform`.product.product_id ,`e-com-platform`.product.name, `e-com-platform`.product.price,`e-com-platform`.product.images,`e-com-platform`.seller.seller_name AS seller_name\n" +
            "            FROM product \n" +
            "            INNER JOIN seller\n" +
